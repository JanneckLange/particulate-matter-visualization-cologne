am4core.ready(async function () {
    ...
    const path = "http://d6977c80.ngrok.io/api";
...
am4core.ready(function () {
    ...
    var chart = am4core.create("timeLineDiv", am4plugins_timeline.SerpentineChart);
    ...
    var textLabel = bullet.createChild(am4core.Label);
    textLabel.text = "{name}";
